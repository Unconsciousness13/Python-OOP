...
class TestCar(unittest.TestCase):
    ...
    def test_negative_fill_capacity(self):
    ...
    def test_drive_not_enough(self):
        self.car.refuel(0.1)
        with self.assertRaises(Exception) as ex:
            self.car.drive(10)
